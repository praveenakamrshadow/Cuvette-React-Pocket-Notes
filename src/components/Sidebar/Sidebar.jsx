...
function Sidebar({ setSelectedGroupName, setSelectedGroupColor }) {
    ...
    useEffect(() => {
        localStorage.setItem(
            "createdNotesGroups",
            JSON.stringify(createdNotesGroups)
        );
    }, [createdNotesGroups]);
        ...
        <div className="container1">
            ...
            >
                <div className="model-data">
                    <h3 style={{ padding: "15px 0px 10px 5px" }}>
                    ...
                    >
                        <h3 style={{ padding: "10px 40px 0px 2px" }}>
                            Group Name
                        </h3>
                        <input
                            type="text"
                    ...
                    >
                        <h3 style={{ padding: "10px 40px 0px 0px" }}>
                            Select Color
                        </h3>
                        {colors.map((color, index) => (
                            <button
                                className={`color ${
                                    index === notesGroup.colorIndex
                                        ? "clicked"
                                        : ""
                                }`}
                                style={{
